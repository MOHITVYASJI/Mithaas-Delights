...
@api_router.post("/auth/login/phone", response_model=TokenResponse)
async def login_with_phone(credentials: UserLoginWithPhone):
    """Login user with phone number and return JWT token"""
